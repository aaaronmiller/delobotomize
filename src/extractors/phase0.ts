...
export class Phase0Extractor {
  ...
  private determineRelationship(insight: Insight, artifact: Artifact): 'explains' | 'exemplifies' | 'solves' | 'relates_to' {
...
export { type ExtractionResult, type Artifact, type Insight };